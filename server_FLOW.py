...
while True: 
    ...
    if 0 <= now.hour <= 23 and 0 <= now.minute <= 59 and 0 <= now.second <= 59: # 9시 0분 20~30초 사이
        ...
        m5_FLOW_2_4 = m5_FLOW_2[-4]
        m5_FLOW_2_3 = m5_FLOW_2[-3]
        m5_FLOW_2_2 = m5_FLOW_2[-2]
        m5_FLOW_2_1 = m5_FLOW_2[-1]
        m5_FLOW_1_4 = m5_FLOW_1[-4]
        m5_FLOW_1_3 = m5_FLOW_1[-3]
    ...
    if op_mode_FLOW is True and hold_FLOW is False and price_FLOW is not None and\
        m5_FLOW_2_4 - m5_FLOW_1_4 > 0 and m5_FLOW_2_3 - m5_FLOW_1_3 > 0 and m5_FLOW_2_2 - m5_FLOW_1_2 > 0 and m5_FLOW_2_1 - m5_FLOW_1_1 < 0 and\
