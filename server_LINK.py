...
while True: 
    ...
    if 0 <= now.hour <= 23 and 0 <= now.minute <= 59 and 0 <= now.second <= 59: # 9시 0분 20~30초 사이
        ...
        m5_LINK_2_4 = m5_LINK_2[-4]
        m5_LINK_2_3 = m5_LINK_2[-3]
        m5_LINK_2_2 = m5_LINK_2[-2]
        m5_LINK_2_1 = m5_LINK_2[-1]
        m5_LINK_1_4 = m5_LINK_1[-4]
        m5_LINK_1_3 = m5_LINK_1[-3]
    ...
    if op_mode_LINK is True and hold_LINK is False and price_LINK is not None and\
        m5_LINK_2_4 - m5_LINK_1_4 > 0 and m5_LINK_2_3 - m5_LINK_1_3 > 0 and m5_LINK_2_2 - m5_LINK_1_2 > 0 and m5_LINK_2_1 - m5_LINK_1_1 < 0 and\
