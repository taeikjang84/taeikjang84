...
while True: 
    ...
    if op_mode_BTC is True and hold_BTC is True and\
        ...
        hold_BTC = False
        print("Stime:", now, "Sprice(BTC):", price_BTC, "이익:", round(((price_BTC - Buy_BTC) - (Buy_BTC * 0.0005) + (price_BTC * 0.0005))/(price_BTC) * 10000, 1))
        op_mode_BTC = False
        # time.sleep(1)
    if op_mode_ETH is True and hold_ETH is True and\
        ...
        hold_ETH = False
        print("Stime:", now, "Sprice(ETH):", price_ETH, "이익:", round(((price_ETH - Buy_ETH) - (Buy_ETH * 0.0005) + (price_ETH * 0.0005))/(price_ETH) * 10000, 1))
        op_mode_ETH = False
        # time.sleep(1)
    if op_mode_BCH is True and hold_BCH is True and\
        ...
        hold_BCH = False
        print("Stime:", now, "Sprice(BCH):", price_BCH, "이익:", round(((price_BCH - Buy_BCH) - (Buy_BCH * 0.0005) + (price_BCH * 0.0005))/(price_BCH) * 10000, 1))
        op_mode_BCH = False
        # time.sleep(1)
    if op_mode_BSV is True and hold_BSV is True and\
        ...
        hold_BSV = False
        print("Stime:", now, "Sprice(BSV):", price_BSV, "이익:", round(((price_BSV - Buy_BSV) - (Buy_BSV * 0.0005) + (price_BSV * 0.0005))/(price_BSV) * 10000, 1))
        op_mode_BSV = False
        # time.sleep(1)
    if op_mode_LTC is True and hold_LTC is True and\
        ...
        hold_LTC = False
        print("Stime:", now, "Sprice(LTC):", price_LTC, "이익:", round(((price_LTC - Buy_LTC) - (Buy_LTC * 0.0005) + (price_LTC * 0.0005))/(price_LTC) * 10000, 1))
        op_mode_LTC = False
        # time.sleep(1)
    if op_mode_BTG is True and hold_BTG is True and\
        ...
        hold_BTG = False
        print("Stime:", now, "Sprice(BTG):", price_BTG, "이익:", round(((price_BTG - Buy_BTG) - (Buy_BTG * 0.0005) + (price_BTG * 0.0005))/(price_BTG) * 10000, 1))
        op_mode_BTG = False
        # time.sleep(1)
    if op_mode_NEO is True and hold_NEO is True and\
        ...
        hold_NEO = False
        print("Stime:", now, "Sprice(NEO):", price_NEO, "이익:", round(((price_NEO - Buy_NEO) - (Buy_NEO * 0.0005) + (price_NEO * 0.0005))/(price_NEO) * 10000, 1))
        op_mode_NEO = False
        # time.sleep(1)
    if op_mode_ETC is True and hold_ETC is True and\
        ...
        hold_ETC = False
        print("Stime:", now, "Sprice(ETC):", price_ETC, "이익:", round(((price_ETC - Buy_ETC) - (Buy_ETC * 0.0005) + (price_ETC * 0.0005))/(price_ETC) * 10000, 1))
        op_mode_ETC = False
        # time.sleep(1)
    if op_mode_BCHA is True and hold_BCHA is True and\
        ...
        hold_BCHA = False
        print("Stime:", now, "Sprice(BCHA):", price_BCHA, "이익:", round(((price_BCHA - Buy_BCHA) - (Buy_BCHA * 0.0005) + (price_BCHA * 0.0005))/(price_BCHA) * 10000, 1))
        op_mode_BCHA = False
        # time.sleep(1)
    if op_mode_REP is True and hold_REP is True and\
        ...
        hold_REP = False
        print("Stime:", now, "Sprice(REP):", price_REP, "이익:", round(((price_REP - Buy_REP) - (Buy_REP * 0.0005) + (price_REP * 0.0005))/(price_REP) * 10000, 1))
        op_mode_REP = False
        # time.sleep(1)
    if op_mode_LINK is True and hold_LINK is True and\
        ...
        hold_LINK = False
        print("Stime:", now, "Sprice(LINK):", price_LINK, "이익:", round(((price_LINK - Buy_LINK) - (Buy_LINK * 0.0005) + (price_LINK * 0.0005))/(price_LINK) * 10000, 1))
        op_mode_LINK = False
        # time.sleep(1)
    if op_mode_DOT is True and hold_DOT is True and\
        ...
        hold_DOT = False
        print("Stime:", now, "Sprice(DOT):", price_DOT, "이익:", round(((price_DOT - Buy_DOT) - (Buy_DOT * 0.0005) + (price_DOT * 0.0005))/(price_DOT) * 10000, 1))
        op_mode_DOT = False
        # time.sleep(1)
    if op_mode_QTUM is True and hold_QTUM is True and\
        ...
        hold_QTUM = False
        print("Stime:", now, "Sprice(QTUM):", price_QTUM, "이익:", round(((price_QTUM - Buy_QTUM) - (Buy_QTUM * 0.0005) + (price_QTUM * 0.0005))/(price_QTUM) * 10000, 1))
        op_mode_QTUM = False
        # time.sleep(1)
    if op_mode_ATOM is True and hold_ATOM is True and\
        ...
        hold_ATOM = False
        print("Stime:", now, "Sprice(ATOM):", price_ATOM, "이익:", round(((price_ATOM - Buy_ATOM) - (Buy_ATOM * 0.0005) + (price_ATOM * 0.0005))/(price_ATOM) * 10000, 1))
        op_mode_ATOM = False
        # time.sleep(1)
    if op_mode_WAVES is True and hold_WAVES is True and\
        ...
        hold_WAVES = False
        print("Stime:", now, "Sprice(WAVES):", price_WAVES, "이익:", round(((price_WAVES - Buy_WAVES) - (Buy_WAVES * 0.0005) + (price_WAVES * 0.0005))/(price_WAVES) * 10000, 1))
        op_mode_WAVES = False
        # time.sleep(1)
    if op_mode_EOS is True and hold_EOS is True and\
        ...
        hold_EOS = False
        print("Stime:", now, "Sprice(EOS):", price_EOS, "이익:", round(((price_EOS - Buy_EOS) - (Buy_EOS * 0.0005) + (price_EOS * 0.0005))/(price_EOS) * 10000, 1))
        op_mode_EOS = False
        # time.sleep(1)
    if op_mode_STRK is True and hold_STRK is True and\
        ...
        hold_STRK = False
        print("Stime:", now, "Sprice(STRK):", price_STRK, "이익:", round(((price_STRK - Buy_STRK) - (Buy_STRK * 0.0005) + (price_STRK * 0.0005))/(price_STRK) * 10000, 1))
        op_mode_STRK = False
        # time.sleep(1)
    if op_mode_GAS is True and hold_GAS is True and\
        ...
        hold_GAS = False
        print("Stime:", now, "Sprice(GAS):", price_GAS, "이익:", round(((price_GAS - Buy_GAS) - (Buy_GAS * 0.0005) + (price_GAS * 0.0005))/(price_GAS) * 10000, 1))
        op_mode_GAS = False
        # time.sleep(1)
    if op_mode_OMG is True and hold_OMG is True and\
        ...
        hold_OMG = False
        print("Stime:", now, "Sprice(OMG):", price_OMG, "이익:", round(((price_OMG - Buy_OMG) - (Buy_OMG * 0.0005) + (price_OMG * 0.0005))/(price_OMG) * 10000, 1))
        op_mode_OMG = False
        # time.sleep(1)
    if op_mode_THETA is True and hold_THETA is True and\
        ...
        hold_THETA = False
        print("Stime:", now, "Sprice(THETA):", price_THETA, "이익:", round(((price_THETA - Buy_THETA) - (Buy_THETA * 0.0005) + (price_THETA * 0.0005))/(price_THETA) * 10000, 1))
        op_mode_THETA = False
        # time.sleep(1)
    if op_mode_TON is True and hold_TON is True and\
        ...
        hold_TON = False
        print("Stime:", now, "Sprice(TON):", price_TON, "이익:", round(((price_TON - Buy_TON) - (Buy_TON * 0.0005) + (price_TON * 0.0005))/(price_TON) * 10000, 1))
        op_mode_TON = False
        # time.sleep(1)
    if op_mode_LSK is True and hold_LSK is True and\
        ...
        hold_LSK = False
        print("Stime:", now, "Sprice(LSK):", price_LSK, "이익:", round(((price_LSK - Buy_LSK) - (Buy_LSK * 0.0005) + (price_LSK * 0.0005))/(price_LSK) * 10000, 1))
        op_mode_LSK = False
        # time.sleep(1)
    if op_mode_SRM is True and hold_SRM is True and\
        ...
        hold_SRM = False
        print("Stime:", now, "Sprice(SRM):", price_SRM, "이익:", round(((price_SRM - Buy_SRM) - (Buy_SRM * 0.0005) + (price_SRM * 0.0005))/(price_SRM) * 10000, 1))
        op_mode_SRM = False
        # time.sleep(1)
    if op_mode_FLOW is True and hold_FLOW is True and\
        ...
        hold_FLOW = False
        print("Stime:", now, "Sprice(FLOW):", price_FLOW, "이익:", round(((price_FLOW - Buy_FLOW) - (Buy_FLOW * 0.0005) + (price_FLOW * 0.0005))/(price_FLOW) * 10000, 1))
        op_mode_FLOW = False
        # time.sleep(1)
